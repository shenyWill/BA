...
//////////////////////////////////////////////////////////////////////////////////
(function ($) {
    $('.product-view').on('hover', '.product-img-box .more-views li', function() {
        var index =$(this).index()
        var index_src = $(this).find('img').attr('big-src');
        $('.product-image img').attr({'src': index_src}).show(100);
        $('#zoom1,.zoom-img a').attr({'href': index_src});
        $('.zoom-img a img').attr({'src': index_src});
        $('.mousetrap').remove();
...
/* Add a box (mouseTrap) over the small image to trap mouse events.
        ...
        */
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
                ...
                zoomDiv = appendTo.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:500px;top:-50px;width:%2px;height:%3px;background:url(\'%4\') no-repeat #fff;z-index:98;border:1px solid #ccc;"></div>', xPos, yPos, w, h, zoomImage.src)).find(':last');
